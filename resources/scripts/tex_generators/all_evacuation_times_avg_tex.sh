...
ylabel = Tiempo promedio de evacuación (s),
xmax = 7,
ymin = 20,
ymax = 160,
grid=both,
...
\addplot[clip marker paths=true,color = blue,mark=*, error bars/.cd,y dir=both, y explicit] table [x index=0, y index=1, y error index=2, col sep=comma]{all_evacuation_times_avg.csv};
\end{axis}
\end{tikzpicture}
